...
/**
 * Clase concreta que define el comportamiento de los productos de tipo Jazz para deporte.
 * Esta clase extiende la clase {@link JazzProduct} y sobreescribe el método {@link #create(SpotifyApi, int)}
 * para crear una lista de canciones de jazz adecuadas para hacer deporte.
 */
public class SportJazz extends JazzProduct {

  /**
   * Método que crea una lista de canciones de jazz para deporte.
   * Realiza una búsqueda en la API de Spotify utilizando el género "jazz" y el estado de ánimo "work".
   *
   ...
   * @return Lista de canciones de jazz para hacer deporte.
   */
  @Override
  public List<Song> create(SpotifyApi spotifyApi, int amount) {
    ...
    // Realizar la solicitud a la API de Spotify para obtener las canciones de jazz para deporte
    ...
    try {
      ...
      _logger.info("Error al obtener las canciones de jazz de deporte: " + e.getMessage());
    }
